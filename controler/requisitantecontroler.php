...
if (isset($_POST['requisitanteid'])) {

    $requisicao->setRequisicaoid($_POST['requisitanteid']);
}
...
switch ($control) {
    ...
    case 'view': {
            ...
            $requisicoes = requisicaoAction::listRequisicaousuario($datainicial, $datafinal, $usuario);
            ...
            include_once '../table/requisitantetable.php';
        }break;
    ...
    case 'relatorio': {
            ...
            if (count($requisicoes) > 0) {
                ...
                $msg[] = util::gerarPDF($relatorio, "Relatório de Requisições");
            } else {
