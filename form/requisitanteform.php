...
<?php } ?>
            ...
            $("#requisicaoativo").selectmenu({width: '8em'});
            $("#brequisicaosubmit").button({
                icons: {primary: "ui-icon-disk"}
            });

            $("#produtoselect").on("selectmenuselect", function() {
                ...
                if (option.val() !== "") {
                    ...
                    $("#controleestoquevalor").val(option.attr("data-customedio"));
                }
            });

            $("#requisicaoaprovacao, #requisicaorecebimento").datepicker({
                dateFormat: "dd/mm/yy"
            });
            ...
            $("#controleestoquequantidade, #controleestoquevalor").change(function() {
                ...
                $("#controleestoquetotal").val(total.toFixed(2));
            });
            ...
            $("#brequisicaosubmit").click(function() {
                $.ajax({
                    type: "POST",
                    url: "<?= $urlroot ?>/controler/requisitantecontroler.php",
            ...
            <div class="linha-form">
                <div class="coluna-form">
                    ...
                    <input
                        ...
                        <?php if ($requisicao->getUsuarioid() == "") { ?>
                            value="<?= $usuario->getUsuarionome() ?>"
                        <?php } else { ?>
                            value="<?= $requisicao->getUsuarionome() ?>"
                        <?php } if ($requisicao->getRequisicaosituacao() > 1 || $situacao == "consultar") { ?>
                            disabled="disabled"
                        <?php } ?>
                        >
                    <input
                ...
                <div class="coluna-form">
                    ...
                    <input 
                        ...
                        required="required" 
                        class="text ui-widget-content ui-corner-all" 
                        <?php if ($requisicao->getRequisicaoemissao(TRUE) != "") { ?>
                ...
                <div style="float: right;">
                    <div class="coluna-form">
                        <div class="button-form">
                            <div>
                                <?php if ($situacao != "consultar") { ?>
                                <div id="setaGravar" style="position: absolute; right: 136px; top: 148px;">
        ...
        <fieldset class="ui-widget-content">
            ...
            <?php if ($situacao == "novo" || $situacao == "editar") { ?>
                <form id="requisicaoitemform">
                    ...
                    <div class="linha-form" style="width: 709px;">
                        <div class="coluna-form">
                            ...
                            <input 
                                ...
                                maxlength="10"
                                placeholder="0,000"
                                style="text-align: right; width: 123px;"
                                class="text ui-widget-content ui-corner-all" 
                                value="">
                        </div>
                        <div class="coluna-form">
                        ...
                        <div class="coluna-form">
                            ...
                            <input 
                                ...
                                maxlength="10"
                                placeholder="R$ 0,00"
                                style="text-align: right; width: 122px;"
                                class="text ui-widget-content ui-corner-all" 
                                value="">
                        </div>
                        <div class="coluna-form">
            ...
            <?php } ?>
            <div id="produtoitem" style="margin: 0 0 0.5em; width: 700px; height: 181px;">
