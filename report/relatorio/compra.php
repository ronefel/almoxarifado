        ...
        <htmlpageheader name="myheader">
            <table width="100%">
                <tr>
                    ...
                    <td width="75%"><br/><span style="font-size: 16pt;">Almoxarifado</span><br/><span style="font-size: 16pt; font-weight: bold; ">Relatório de Compras</span></td>
                </tr>
            </table>
        </htmlpageheader>
        ...
        <table class="items" width="100%" style="border-collapse: collapse;" cellpadding="8">
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($compras); $i++) {
                    $valortotal += $compras[$i]->getCompravalortotal();
                    ?>
                    <tr>
                        ...
                        <td>
                            <?= $compras[$i]->getFantazia("form") ?>
                        </td>
                        <td>
                            <?= $compras[$i]->getComprasituacaonome() ?>
                        </td>
                        <td style="text-align: right;">
                            <?= $compras[$i]->getCompravalortotal("form") ?>
                        </td>
                    </tr>
                <?php } ?>
                    <tr>
